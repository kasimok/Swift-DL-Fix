...
class ViewController: NSViewController {
    ...
    override func viewDidLoad() {
        ...
        if ProcessInfo.processInfo.environment["fill_test_url"] == "yes"{
            if let urls = ProcessInfo.processInfo.environment["test_url"]{
                debugPrint("auto filled test url: \(urls)")
                inputURLS.string = "https://www.youtube.com/watch?v=Rvi6c8toWJM&ab_channel=WalkmanPlays"
            }
        }
